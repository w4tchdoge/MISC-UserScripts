...
// @history        1.0.3 — Modify XPath to get the existing "My Bookmarks" button to accommodate the DOM element with id "greeting" not being a div element
...
(function () {
	...
	var bkmrks_btn = document.evaluate(`.//*[@id="greeting"]//li//a[text()[contains(.,'My Bookmarks')]]`, document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
